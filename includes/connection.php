...
/* %%%%%%%%%%%%%%%%% CONFIGURACIÓN   */
	...
	$logo2			= 'img/design/logo.png';
	$mailBGcolor 	= '#DDD';
	$mailButton 	= '#ff8b00';
	$uikitVersion	= '3.2.0';
	$languaje		= 'es';
	$appID			= '1113585822365178';
	$googleMaps		= 'AIzaSyAA_lgquFXipMbdNCXe5EFDxbUdoHZBBlg';
	$efra			= 'info@efra.biz';

	$database 		= 'casapiel_casapiel';
	...
	$databasePreview= 'eshotmx_casapiel';
...
/* %%%%%%%%%%%%%%%%% OTRAS VARIABLES   */
	...
	// Metadatos
		...
		$about   		   = $row_CONSULTA['about1'];
		$variedad		   = $row_CONSULTA['about2'];
		$trabajo           = $row_CONSULTA['about3'];
		$aboutEn		   = $row_CONSULTA['about1_en'];
		$variedadEn		   = $row_CONSULTA['about2_en'];
		$trabajoEn		   = $row_CONSULTA['about3_en'];
		$nosotrosImg       = $row_CONSULTA['imagen2'];
		$nosotrosImg2      = $row_CONSULTA['imagen4'];

		$RemitenteMail 	   = $row_CONSULTA['remitente'];
		$destinatario1 	   = $row_CONSULTA['destinatario1'];
		$destinatario2 	   = $row_CONSULTA['destinatario2'];
		$contactoImg       = $row_CONSULTA['imagen5'];

		$instrucciones     = $row_CONSULTA['instrucciones'];
		$instruccionesEng  = $row_CONSULTA['instrucciones_eng'];
