var svgIconConfig = {
	clock : { 
		url : 'library/AnimatedSVGIcons/svg/clock.svg',
		animation : [
			{ 
				el : 'path:nth-child(2)', 
				animProperties : { 
	...
	trash : { 
		url : 'library/AnimatedSVGIcons/svg/trash.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	contract : { 
		url : 'library/AnimatedSVGIcons/svg/contract.svg',
		animation : [
			{ 
				el : 'rect:nth-child(2)', 
				animProperties : { 
	...
	maximize : { 
		url : 'library/AnimatedSVGIcons/svg/maximize.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	volume : {
		url : 'library/AnimatedSVGIcons/svg/volume.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	plus : { 
		url : 'library/AnimatedSVGIcons/svg/plus.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	close : { 
		...
		animation : [
			...
			{ 
				...
				animProperties : { 
					from : { val : '{"transform" : "r0 32 32"}' }, 
					to : { val : '{"transform" : "r135 32 32"}' }
				} 
			}
		]
	},
	hamburger : {
		url : 'library/AnimatedSVGIcons/svg/hamburger.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	navLeftArrow : {
		url : 'library/AnimatedSVGIcons/svg/nav-left-arrow.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	navUpArrow : {
		url : 'library/AnimatedSVGIcons/svg/nav-up-arrow.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	rightArrow : {
		url : 'library/AnimatedSVGIcons/svg/right-arrow.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	downArrow : {
		url : 'library/AnimatedSVGIcons/svg/down-arrow.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	smiley : {
		url : 'library/AnimatedSVGIcons/svg/smiley.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	play : {
		url : 'library/AnimatedSVGIcons/svg/play.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	mail : {
		url : 'library/AnimatedSVGIcons/svg/mail.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	equalizer : {
		url : 'library/AnimatedSVGIcons/svg/equalizer.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	glass : {
		url : 'library/AnimatedSVGIcons/svg/glass.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	hourglass : {
		url : 'library/AnimatedSVGIcons/svg/hourglass.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	padlock : {
		url : 'library/AnimatedSVGIcons/svg/padlock.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	zoom : {
		url : 'library/AnimatedSVGIcons/svg/zoom.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	monitor : {
		url : 'library/AnimatedSVGIcons/svg/monitor.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	flag : {
		url : 'library/AnimatedSVGIcons/svg/flag.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
