	...
	<div class="uk-container">
 	 	<?php 
  			if ( $languaje == 'es') {
    			...
    			$btnText3 = "Actualizar";
    			$btnText4 = "Continuar";
				$txtCup1 = "¿Tienes un cupón de descuento?";
				$txtCup2 = "Ingresa el cupón";
				$btnCup1 = "Validar cupón";
				$btnCup2 = "Continuar sin cupón";
				$msgCupT = "El cupón es valido, aplica descuento del ";
				$msgCupF = "Cupón no valido, no se aplicará el descuento";
    			...
    			$btnText3 = "Update";
    			$btnText4 = "Continue";
				$txtCup1 = "Do you have a discount coupon?";
				$txtCup2 = "Enter the coupon code";
				$btnCup1 = "Validate coupon";
				$btnCup2 = "Continue without coupon";
				$msgCupT = "The coupon is valid, apply a discount of ";
				$msgCupF = "Coupon not valid, the discount will not be applied";
  			...
  			if ($carroTotalProds>0) {
            	...
            	echo '
              		<form action="" method="post" class="barra_cupon">
                		...
                		<div>
                  			<input class="uk-input" id="cuponinput" name="cuponinput" placeholder="'.$txtCup2.'">
                		</div>
                		<div>
                  			<input name="subir" type="submit" class="uk-button uk-button-default" id="cuponavalidar" value="'.$btnCup1.'">
							<input name="negar" type="submit" class="uk-button uk-button-default" id="cuponnegar" value="'.$btnCup2.'">
                		</div>
              		</form>
					</div>
              	';
    				...
    				<form method="post">
        				...
        				<div uk-grid class="uk-flex-center">
          				...
          				<div>
            				...
            				<a href="EnvioPago" class="uk-button uk-button-large uk-button-personal" id="siguiente">'.$btnText4.' &nbsp; <i uk-icon="icon:arrow-right;ratio:1.5;"></i></a>
          				</div>
        			</div>
      			</div>
    		</form>
