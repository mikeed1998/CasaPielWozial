...
<div uk-grid>
	<div class="uk-width-auto@m margin-top-20">
		<ul class="uk-breadcrumb">
			...
			<li><a href="index.php?rand='.rand(1,999999).'&seccion='.$seccion.'&subseccion=solicitudes">Solicitudes</a></li>
			<li><a href="index.php?rand='.rand(1,999999).'&seccion='.$seccion.'&subseccion='.$subseccion.'&pag='.$pag.'" class="color-red">Solicitudes archivadas</a></li>
			';
			?>
		</ul>
	</div>
		...
		while($row_CONSULTA = $CONSULTA -> fetch_assoc()){
			...
			echo '
				...
				<td class="uk-text-nowrap">
					...
					<a href="index.php?rand='.rand(1,999999).'&seccion='.$seccion.'&subseccion=solicitudesdetalle&pag='.$pag.'&id='.$row_CONSULTA['id'].'" class="uk-icon-button uk-button-primary"><i class="fas fa-search-plus"></i></a>
				</td>
			</tr>';
		}
		?>
...
<div class="uk-width-1-1 padding-top-50">
	<div uk-grid class="uk-flex-center">
		<div>
			...
			<?php
			if ($pag!=0) {
				$link='index.php?rand='.rand(1,999999).'&seccion='.$seccion.'&subseccion='.$subseccion.'&pag='.($pag-1).'&prodspagina='.$prodspagina;
				echo'
			...
			for ($i=0; $i <= $pagTotal; $i++) { 
				...
				$link='index.php?rand='.rand(1,999999).'&seccion='.$seccion.'&subseccion='.$subseccion.'&pag='.($i).'&prodspagina='.$prodspagina;
...
$(function(){
	...
	$(".eliminarpedido").click(function() {
		...
		if (statusConfirm == true) { 
			window.location = ("index.php?rand='.rand(1,9999).'&seccion='.$seccion.'&subseccion='.$subseccion.'&pag='.$pag.'&borrarPedido&id="+id);
		} 
	});
