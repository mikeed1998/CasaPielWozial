...
$rowCONSULTA = $CONSULTA -> fetch_assoc();
	...
	$pic='../img/contenido/varios/'.$rowCONSULTA['pdf1'];
	if(strlen($rowCONSULTA['pdf1'])>0 AND file_exists($pic)){
		...
		$pdf='
		<div class="uk-panel uk-text-center">
			<p class="uk-scrollable-box"><i uk-icon="icon:ban;ratio:5;"></i><br><br>
...
<div class="uk-width-auto@m margin-top-20">
	<ul class="uk-breadcrumb uk-text-capitalize">
		...
		<li><a href="index.php?rand='.rand(1,1000).'&seccion='.$seccion.'&subseccion='.$subseccion.'" class="color-red">Catálogo</a></li>
	</ul>
</div>
...
$scripts.='
	$(document).ready(function() {
		$("#fileuploader").uploadFile({
			...
			onSuccess:function(data){ 
				window.location = (\'index.php?seccion='.$seccion.'&subseccion='.$subseccion.'&campo=pdf1&fileuploaded=\'+data);
			}
		});
	});	
	...
	$(".borrarpic").click(function() {
		...
		if (statusConfirm == true) { 
			window.location = ("index.php?seccion='.$seccion.'&subseccion='.$subseccion.'&campo=pdf1&borrarpic=1");
		} 
	});
